<?php
/**
 * Plugin Name: WooCommerce Extension for Éholtóság
 * Version: 1.0.0
 * Plugin URI: https://github.com/op-aiee/eholtosag-woocommerce
 * Description:
 * Author: Lorant Nemeth
 * Author URI:
 * Requires at least: 4.4.0
 * Tested up to: 5.0
 *
 * Text Domain: eholtosag-woocommerce
	...
	class WooCommerce_Plugin_Extension_Boilerplate {
		...
		*/
        ...
        public static function activate() {
            include_once 'includes/eholtosag-woocommerce-activate.php';
        ...
        public static function deactivate() {
            include_once 'includes/eholtosag-woocommerce-deactivate.php';
		...
		public function includes() {
			include_once 'includes/eholtosag-woocommerce-functions.php';
		}
		...
		public function load_plugin_textdomain() {
			$locale = apply_filters( 'wepb_plugin_locale', get_locale(), 'eholtosag-woocommerce' );
